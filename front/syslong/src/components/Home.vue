<template>
  <el-container class="home-container">
    <el-header>
      ...
      <div v-if="active_user" class="header-loginstatus">
        <span>欢迎您 {{ this.active_user }}</span>
        <el-button type="info" size="mini" @click="logout">登出</el-button>
      </div>
      <div v-else class="header-loginstatus">
    ...
    <el-container>
      <el-aside :width="aside_closed ? '40px': '200px'">
        <div class="fold-button" @click="fold_aside">||||</div>
        ...
        <el-menu
          ...
          unique-opened
          router
          :collapse="aside_closed"
          :collapse-transition="false"
          active-text-color="#409EFF"
          :default-active="active_path"
        >
          <el-submenu v-for="menu1 in menuList" :key="menu1.path" :index="menu1.path">
            <template slot="title">
            ...
            <el-menu-item
              ...
              :key="menu2.path"
              :index="menu2.path"
              @click="saveActivePath(menu2.path)"
            >
              <template>
